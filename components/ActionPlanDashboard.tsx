...
import type { HistoricalAnalysis, DailyActionPlan, AiConfig, GscTokenResponse, WatchedKeyword } from '../types';
...
import { KeywordWatchtower } from './KeywordWatchtower';
...
interface ActionPlanDashboardProps {
    ...
    onWatchedKeywordsUpdate: (keywords: WatchedKeyword[]) => void;
}
...
export const ActionPlanDashboard: React.FC<ActionPlanDashboardProps> = (props) => {
    const { analysis, onToggleTaskComplete, aiConfig, isGscConnected, onConnectGscClick, gscToken, updateAnalysis, watchedKeywords, onWatchedKeywordsUpdate } = props;
    ...
    return (
        <div className="space-y-10">
            ...
            <KeywordWatchtower
                ...
                onUpdate={onWatchedKeywordsUpdate}
                aiConfig={aiConfig}
            />
